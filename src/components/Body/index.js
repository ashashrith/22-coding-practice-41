        ...
        {value => {
            ...
            return(
                ...
                <div className='content-cont'>
                    ...
                    <p className='para'>Lorem ispum dolor sit amet, consectetur adipiscing elit, sed do 
                    eiusmod tempor icididunt ut labore et dolore magna aliqua. Ut anim ad minim veniam.</p>
                </div>}
                {showLeftNavbar $$ 
